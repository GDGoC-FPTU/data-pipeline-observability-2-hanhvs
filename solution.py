...
def validate(data):
    ...
    for record in data:
        ...
        # Check price is valid (not None, convertible to float, and > 0)
        ...
        # Check category is valid (not None and not empty string after strip)
...
def transform(data):
    ...
    # Format category in Title Case
    df['category'] = df['category'].astype(str).str.title()
    
    # Add extraction / processing timestamp
    df['processed_at'] = datetime.datetime.now().isoformat()
